...
neighborController.prototype.getAlive = function () {
    ...
    if (this.grilleController.get()[this.line][this.row - 1] == true) this.neighbors++;
    if (this.grilleController.get()[this.line][this.row + 1] == true) this.neighbors++;

    if (this.grilleController.get()[this.line - 1][this.row - 1] == true) this.neighbors++;
    if (this.grilleController.get()[this.line + 1][this.row - 1] == true) this.neighbors++;

    if (this.grilleController.get()[this.line - 1][this.row + 1] == true) this.neighbors++;
    if (this.grilleController.get()[this.line + 1][this.row + 1] == true) this.neighbors++;

    if (this.grilleController.get()[this.line - 1][this.row] == true) this.neighbors++;
    if (this.grilleController.get()[this.line + 1][this.row] == true) this.neighbors++;
